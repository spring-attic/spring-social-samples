...
import org.springframework.social.popup.account.JdbcAccountRepository;
 ...
 */
@Configuration
@ComponentScan(basePackages = "org.springframework.social.popup", excludeFilters = { @Filter(Configuration.class) })
@PropertySource("classpath:org/springframework/social/popup/config/application.properties")
