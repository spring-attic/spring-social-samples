...
import org.springframework.social.movies.account.JdbcAccountRepository;
import org.springframework.social.movies.review.JdbcReviewRepository;
...
public class MainConfig {
	...
	private DatabasePopulator databasePopulator() {
		...
		populator.addScript(new ClassPathResource("Review.sql", JdbcReviewRepository.class));
